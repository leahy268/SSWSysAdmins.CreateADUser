...
Function LogWrite {
    ...
    $SharePointSiteUrl = "https://sswcom.sharepoint.com/sites/SSWSysAdmins"
    ...
    foreach ($User in $UserList) {  
        ...
        if ($User["SysAdmin_User_Created"] -eq $false) {
            ...
            $Office = $User["SysAdmin_User_Office"]
            ...
            try {
                ...
                $bodyhtml += "<p>Tip: You can find a log file with more information at $env:computername in $LogFile</p>"
                $bodyhtml += "<p>Documentation for the SSWSysAdmins.CreateADUser: <br>"
                $bodyhtml += "Public - <a href=https://github.com/SSWConsulting/SSWSysAdmins.CreateADUser> SSWSysAdmins.SSWCreateADUser Github </a><br>"
                $bodyhtml += "Internal - <a href=https://sswcom.sharepoint.com/:w:/g/SysAdmin/EXvH_G59-QNAgusHshEhQtEB8egZa_pXAdAZb8SlCx20Pw?e=bfFt93> SSWSysAdmins.SSWCreateADUser SharePoint </a></p>"
                $bodyhtml += "<p></p>"
                $bodyhtml += "<p>-- Powered by SSWSysAdmins.CreateADUser<br /> Server: $env:computername </p>"
            
                Send-MailMessage -from "sswserverevents@ssw.com.au" -to "SSWSysAdmins@ssw.com.au" -Subject "FAILED: SSWSysAdmins.CreateADUser - New AD User: $Firstname $Surname" -Body $bodyhtml -SmtpServer "ssw-com-au.mail.protection.outlook.com" -bodyashtml
            ...
            try {
                ...
                Invoke-Command -ComputerName SYDSSWDCP01 -ScriptBlock { Start-ADSyncSyncCycle -PolicyType Delta }
            ...
            #$bodyhtml += "<p>-- Powered by SSWSysAdmins.CreateADUser<br /> Server: $env:computername </p>"
            #
            #Send-MailMessage -from "sswserverevents@ssw.com.au" -to "SSWSysAdmins@ssw.com.au" -Subject "NFAILED: SSWSysAdmins.CreateADUser - New AD User: $Firstname $Surname" -Body $bodyhtml -SmtpServer "ssw-com-au.mail.protection.outlook.com" -bodyashtml
            #
            #break
            #}
